...
%---------------------------------------------------------
  ...
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Lead engineer on shipping system. Includes address validation via UPS Connectship, custom label generating, and package rating via UPS, FedEx, Doorman, Deliv, TForce, Breakaway with a deterministic shipping method outcome.} % Shipmunk
